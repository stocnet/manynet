...
glossies <- list(
  ...
  aesthetic = "An aesthetic is a visual channel, such as colour, shape, or size, to which data can be mapped.",
  ...
  centrality = "Centrality is a family of measures of the importance of nodes in a network.",
  ...
  equivalency = "Equivalency or reinforcement is the proportion of three-paths in a two-mode network that are closed by a fourth tie into a four-cycle.",
  Eulerian = "An Eulerian path is a walk that uses each tie in a network exactly once.",
  faction = "A faction is one of a fixed number of mutually exclusive groups into which a network is partitioned.",
  `force-directed` = "A force-directed layout is one of a family of layouts that place nodes by simulating attractive forces between connected nodes and repulsive forces between all nodes.",
  ...
  graph = "A graph is a drawing or diagram of a network, as distinct from the network itself.",
  ...
  layout = "A layout is an algorithmic placement of the nodes of a network in space for visualisation.",
  legend = "A legend is a key that explains what the colours, shapes, or sizes in a network visualisation signify.",
  longitudinal = "A longitudinal network is one observed in two or more discrete waves or panels over time.",
  ...
  reach = "The reach centrality of a node is the share of the network it can reach within a given number of steps.",
  ...
  signed = "A signed network is one where ties are marked as positive or negative, such as friendship and enmity or alliance and conflict.",
  ...
  spectral = "A spectral layout is one of a family of layouts that place nodes using the eigenvectors of the Laplacian matrix of the network.",
  ...
  twomode = "A two-mode (or bipartite) network is a network with two different sets of nodes, where ties connect only nodes from different sets, such as people and the events they attend.",
