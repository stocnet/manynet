...
```{r ison_egs, echo = FALSE, dpi = 250, message=FALSE}
library(patchwork)
(autographr(to_unnamed(ison_karateka)) + ggtitle("Karateka Class", subtitle = "Zachary 1977") + 
  ...
  (autographr(ison_lawfirm) + ggtitle("Law Firm", subtitle = "Lazega 2001") + 
     autographr(ison_algebra, labels = FALSE) + ggtitle("Algebra Class", subtitle = "McFarland 2001"))
```
...
```{r create_egs, echo = FALSE, dpi = 300, message=FALSE, fig.height=3}
...
```{r generate_egs, echo = FALSE, dpi = 300, message=FALSE, fig.height=3}
...
```{r directed_egs, echo = FALSE, dpi = 300, fig.height=3, warning=FALSE, message=FALSE}
...
```{r projection_egs, echo = FALSE, dpi = 300, fig.height=3, warning=FALSE, message=FALSE}
library(ggplot2)
...
```{r splitting_egs, echo = FALSE, dpi = 250, fig.height=4, warning=FALSE, message=FALSE}
...
```{r layout-comparison, echo = FALSE, message=FALSE, dpi = 250, fig.height=4}
library(manynet)
library(igraph)
library(gridBase)
library(grid)
...
```{r more-options, echo = FALSE, message=FALSE, dpi = 300, fig.height=3}
...
```{r more-layouts, echo = FALSE, message=FALSE, dpi = 250}
...
```{r more-themes, echo = FALSE, message=FALSE, dpi = 300, fig.height=3}
...
```{r autographs, echo = FALSE, dpi = 250, fig.height=3}
ison_adolescents %>%
...
```{r autographd, echo = FALSE, dpi = 250, fig.height=3.5}
ison_adolescents %>%
