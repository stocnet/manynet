...
```{r ison_egs, echo = FALSE, dpi = 300, message=FALSE}
library(patchwork)
(autographr(ison_karateka) + ggtitle("Karateka", subtitle = "Zachary 1977") + 
    autographr(ison_southern_women) + ggtitle("Southern Women", subtitle = "Davis et al 1941")) /
  (autographr(ison_lawfirm) + ggtitle("Law Firm", subtitle = "Lazega 2001") + 
     autographr(ison_networkers, labels = FALSE) + ggtitle("Networkers", subtitle = "Freeman and Freeman 1979"))
```
...
```{r create_egs, echo = FALSE, dpi = 300, message=FALSE, fig.height=4}
...
```{r generate_egs, echo = FALSE, dpi = 300, message=FALSE, fig.height=4}
...
```{r generate_tm, echo = FALSE, dpi = 300, message=FALSE, fig.height=4, warning=FALSE}
...
```{r directed_egs, echo = FALSE, dpi = 300, fig.height=4, warning=FALSE, message=FALSE}
autographr(to_unnamed(ison_networkers)) + ggtitle("Directed", subtitle = "ison_networkers") + 
    autographr(to_undirected(to_unnamed(ison_networkers))) + ggtitle("Undirected", subtitle = "to_undirected(ison_networkers)")
```
...
```{r projection_egs, echo = FALSE, dpi = 300, fig.height=4, warning=FALSE, message=FALSE}
library(ggplot2)
...
```{r splitting_egs, echo = FALSE, dpi = 300, fig.height=4, warning=FALSE, message=FALSE}
autographr(ison_adolescents) + ggtitle("Original", subtitle = "ison_adolescents") + 
    autographs(to_egos(ison_adolescents)) + ggtitle("Ego Splitting", subtitle = "to_egos(ison_adolescents)")
```
...
```{r more-options, echo = FALSE, message=FALSE, dpi = 300}
...
```{r more-layouts, echo = FALSE, message=FALSE, dpi = 300}
(autographr(ison_southern_women, layout = "concentric") + ggtitle("Concentric layout")) /
  ((autographr(create_explicit(A-+B-+C, A-+C)) + ggtitle("Triad layout")) |
  (autographr(create_explicit(A-+C, A-+D, B-+C, B-+D)) + ggtitle("Quad layout")))
```
...
```{r more-themes, echo = FALSE, message=FALSE, dpi = 300}
...
p + p + theme_iheid() + scale_color_iheid() + 
  ...
  ggtitle("ETH Zürich", subtitle = "_ethz")
```
...
```{r autographs, echo = FALSE, dpi = 300, fig.height=4}
ison_adolescents %>%
...
```{r autographd, echo = FALSE, dpi = 300, fig.height=4}
ison_adolescents %>%
