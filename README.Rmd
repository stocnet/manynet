...
There are many great packages, all with their own offerings and advantages, 
...
This package includes a couple of tutorials to help new and experienced users
...
Then we suggest that you check to see which vignettes are currently available:
