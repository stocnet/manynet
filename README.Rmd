...
migraph::autographr(imports, node_size = 2)
```
...
migraph::autographr(igraph::graph_from_literal(edgelist:matrix:igraph:network:tidygraph+--+edgelist:matrix:igraph:network:tidygraph,
