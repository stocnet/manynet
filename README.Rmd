...
```{r layout-comparison, echo = FALSE, message=FALSE, dpi = 300, fig.height=4}
library(manynet)
library(igraph)
library(gridBase)
library(grid)
...
```{r autographs, echo = FALSE, dpi = 300, fig.height=3}
ison_adolescents %>%
...
```{r autographd, echo = FALSE, dpi = 300, fig.height=3.5}
ison_adolescents %>%
